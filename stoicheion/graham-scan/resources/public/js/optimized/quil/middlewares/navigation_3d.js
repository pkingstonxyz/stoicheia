...
var vec__6050 = axis;
var a_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6050,(0),null);
var a_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6050,(1),null);
var a_z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6050,(2),null);
var vec__6053 = v;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6053,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6053,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6053,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__6056,p__6057){
var vec__6058 = p__6056;
var u1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6058,(0),null);
var u2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6058,(1),null);
var u3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6058,(2),null);
var vec__6061 = p__6057;
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6061,(0),null);
var v2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6061,(1),null);
var v3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6061,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__6064_SHARP_){
return (p1__6064_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle(p1__6065_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud(quil.middlewares.navigation_3d.rotate_lr(p1__6066_SHARP_,angle_lr),angle_ud);
...
var map__6068 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6068__$1,cljs.core.cst$kw$up);
var straight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6068__$1,cljs.core.cst$kw$straight);
var temp__5733__auto__ = (function (){var pred__6070 = cljs.core._EQ_;
var expr__6071 = cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_((function (){var G__6073 = cljs.core.cst$kw$w;
var G__6074 = expr__6071;
return (pred__6070.cljs$core$IFn$_invoke$arity$2 ? pred__6070.cljs$core$IFn$_invoke$arity$2(G__6073,G__6074) : pred__6070.call(null,G__6073,G__6074));
})())){
return straight;
} else {
if(cljs.core.truth_((function (){var G__6075 = cljs.core.cst$kw$s;
var G__6076 = expr__6071;
return (pred__6070.cljs$core$IFn$_invoke$arity$2 ? pred__6070.cljs$core$IFn$_invoke$arity$2(G__6075,G__6076) : pred__6070.call(null,G__6075,G__6076));
})())){
return quil.middlewares.navigation_3d.v_opposite(straight);
} else {
if(cljs.core.truth_((pred__6070.cljs$core$IFn$_invoke$arity$2 ? pred__6070.cljs$core$IFn$_invoke$arity$2(quil.middlewares.navigation_3d.space,expr__6071) : pred__6070.call(null,quil.middlewares.navigation_3d.space,expr__6071)))){
return quil.middlewares.navigation_3d.v_opposite(up);
} else {
if(cljs.core.truth_((function (){var G__6077 = cljs.core.cst$kw$z;
var G__6078 = expr__6071;
return (pred__6070.cljs$core$IFn$_invoke$arity$2 ? pred__6070.cljs$core$IFn$_invoke$arity$2(G__6077,G__6078) : pred__6070.call(null,G__6077,G__6078));
})())){
return up;
} else {
if(cljs.core.truth_((function (){var G__6079 = cljs.core.cst$kw$d;
var G__6080 = expr__6071;
return (pred__6070.cljs$core$IFn$_invoke$arity$2 ? pred__6070.cljs$core$IFn$_invoke$arity$2(G__6079,G__6080) : pred__6070.call(null,G__6079,G__6080));
})())){
return quil.middlewares.navigation_3d.cross_product(straight,up);
} else {
if(cljs.core.truth_((function (){var G__6081 = cljs.core.cst$kw$a;
var G__6082 = expr__6071;
return (pred__6070.cljs$core$IFn$_invoke$arity$2 ? pred__6070.cljs$core$IFn$_invoke$arity$2(G__6081,G__6082) : pred__6070.call(null,G__6081,G__6082));
})())){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d,cljs.core.cst$kw$position], null),((function (dir,temp__5733__auto__,map__6068,map__6068__$1,up,straight){
return (function (p1__6067_SHARP_){
return quil.middlewares.navigation_3d.v_plus(p1__6067_SHARP_,quil.middlewares.navigation_3d.v_mult(dir,step_size));
});})(dir,temp__5733__auto__,map__6068,map__6068__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__6083_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var rotate_on_fn = (function (){var G__6084 = options;
var G__6085 = ((function (G__6084,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed){
return (function (state,_){
return state;
});})(G__6084,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed))
;
return (rotate_on.cljs$core$IFn$_invoke$arity$2 ? rotate_on.cljs$core$IFn$_invoke$arity$2(G__6084,G__6085) : rotate_on.call(null,G__6084,G__6085));
})();
...
var map__6086_6101 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__6086_6102__$1 = (((((!((map__6086_6101 == null))))?(((((map__6086_6101.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6086_6101.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6086_6101):map__6086_6101);
var vec__6087_6103 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6086_6102__$1,cljs.core.cst$kw$straight);
var c_x_6104 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6087_6103,(0),null);
var c_y_6105 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6087_6103,(1),null);
var c_z_6106 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6087_6103,(2),null);
var vec__6090_6107 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6086_6102__$1,cljs.core.cst$kw$up);
var u_x_6108 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6090_6107,(0),null);
var u_y_6109 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6090_6107,(1),null);
var u_z_6110 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6090_6107,(2),null);
var vec__6093_6111 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6086_6102__$1,cljs.core.cst$kw$position);
var p_x_6112 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6093_6111,(0),null);
var p_y_6113 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6093_6111,(1),null);
var p_z_6114 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6093_6111,(2),null);
quil.core.camera.cljs$core$IFn$_invoke$arity$9(p_x_6112,p_y_6113,p_z_6114,(p_x_6112 + c_x_6104),(p_y_6113 + c_y_6105),(p_z_6114 + c_z_6106),u_x_6108,u_y_6109,u_z_6110);
...
var G__6097 = quil.middlewares.navigation_3d.move(state,event,step_size);
var G__6098 = event;
return (key_pressed.cljs$core$IFn$_invoke$arity$2 ? key_pressed.cljs$core$IFn$_invoke$arity$2(G__6097,G__6098) : key_pressed.call(null,G__6097,G__6098));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
,rotate_on,((function (user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup){
return (function (state,event){
var G__6099 = quil.middlewares.navigation_3d.rotate(state,event,pixels_in_360);
var G__6100 = event;
return (rotate_on_fn.cljs$core$IFn$_invoke$arity$2 ? rotate_on_fn.cljs$core$IFn$_invoke$arity$2(G__6099,G__6100) : rotate_on_fn.call(null,G__6099,G__6100));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
], 0));
});
