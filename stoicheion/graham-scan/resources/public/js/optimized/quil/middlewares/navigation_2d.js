...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__6610_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_6611 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_6612 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_6611);
var pos_6613 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_6611);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_6612);

var tr__6514__auto___6614 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_6612) - cljs.core.first(pos_6613)),(((quil.core.height() / (2)) / zoom_6612) - cljs.core.second(pos_6613))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__6514__auto___6614);
...
var G__6615 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__6616 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__6615,G__6616) : user_mouse_dragged.call(null,G__6615,G__6616));
...
return (function (state,event){
var G__6617 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__6618 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__6617,G__6618) : user_mouse_wheel.call(null,G__6617,G__6618));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
